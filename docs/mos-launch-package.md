...
| Recht / Datenschutz | Finale Mietbedingungen und konkrete Versicherungsklausel rechtlich prüfen. Vor Livebetrieb den tatsächlich angezeigten Hosted Checkout einschließlich letzter Zusammenfassung und Zahlungsschaltfläche nach [§ 312j BGB](https://www.gesetze-im-internet.de/bgb/__312j.html) abnehmen. Die unverzügliche elektronische Eingangsbestätigung und speicherbare Bedingungen nach [§ 312i BGB](https://www.gesetze-im-internet.de/bgb/__312i.html) sowie eine Vertragsbestätigung auf dauerhaftem Datenträger vor Mietbeginn nach [§ 312f Abs. 2 BGB](https://www.gesetze-im-internet.de/bgb/__312f.html) sind noch nicht als erfüllt nachgewiesen; der derzeitige PDF-Abruf ist an die Browsersitzung gebunden und es gibt keinen automatischen Versand. Die mögliche Pflicht zu einem öffentlichen [Kündigungsbutton nach § 312k BGB](https://www.gesetze-im-internet.de/bgb/__312k.html) für befristete Online-Mieten rechtlich klären; der vorhandene sitzungsgebundene Storno-Knopf ist dafür nicht nachweislich ausreichend. Aufbewahrung/Löschung nicht abgeschlossener Unterschriften festlegen. Der Stripe-Datenfluss steht in der Datenschutzerklärung, die Ergänzung ist rechtlich ungeprüft. Entwurf nicht als freigegebene AGB einsetzen. |
