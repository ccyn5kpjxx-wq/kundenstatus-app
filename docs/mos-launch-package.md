...
| Betrieb / Preise / Bedingungen | i10 39 €/Tag, KONA 59 €/Tag beziehungsweise ab drei berechneten Miettagen 49 €/Tag **für alle gebuchten Tage**, 150 Freikilometer je berechnetem Miettag und 0,25 €/Mehrkilometer, 500 € Kaution, 1.000 € vertragliche Selbstbeteiligung, kein Mindestvorlauf, Montag bis Samstag stündlich 08:00–20:00 Uhr einschließlich, höchstens fünf berechnete Miettage, voll/voll sowie 48 Stunden kostenlos und danach 10 % nur des Mietpreises sind entschieden. Die 24-Stunden-Tagesberechnung, Schaden-/Rückgabeablauf, Puffer, Erreichbarkeit außerhalb der Übergabezeiten und vollständige Mietbedingungen benötigen noch eine abschließende Betreiber- und Rechtsfreigabe. |
...
| Recht / Datenschutz | Finale Mietbedingungen und konkrete Versicherungsklausel rechtlich prüfen. Vor Livebetrieb den tatsächlich angezeigten Hosted Checkout einschließlich letzter Zusammenfassung und Zahlungsschaltfläche nach [§ 312j BGB](https://www.gesetze-im-internet.de/bgb/__312j.html) abnehmen. Der Buchungseinstieg nennt die Zahlungsarten; die Preisübersicht erklärt Korrektur und Ablauf und lässt sich mit den Bedingungen vor der Unterschrift speichern. Die separate neutrale Eingangsbestätigung nach [§ 312i BGB](https://www.gesetze-im-internet.de/bgb/__312i.html) ist technisch vorbereitet, aber ihre unverzügliche Zustellung nicht nachgewiesen. Eine idempotente Vertrags-E-Mail-Outbox und ein gesperrter Versandstarter sind vorbereitet; ein dauerhaft laufender, überwachter Mailworker und die rechtzeitige Zustellung vor Abholung fehlen weiterhin nach [§ 312f Abs. 2 BGB](https://www.gesetze-im-internet.de/bgb/__312f.html). Details: [Vertragszustellung](mos-contract-delivery.md). Die mögliche Pflicht zu einem öffentlichen [Kündigungsbutton nach § 312k BGB](https://www.gesetze-im-internet.de/bgb/__312k.html) für befristete Online-Mieten rechtlich klären; ein eigenständiger öffentlicher Kündigungsweg ist vorbereitet, aber bis zur Rechts-/E-Mail-Abnahme gesperrt. Ein [schreibgeschützter Bericht](mos-unterschriften-aufbewahrung.md) und ein streng gesperrter Löschlauf zu abgebrochenen Unterschriften sind vorbereitet; Aufbewahrungsfrist, Datenschutzhinweis und produktive Löschung bleiben offen. Der Stripe-Datenfluss steht in der Datenschutzerklärung, die Ergänzung ist rechtlich ungeprüft. Entwurf nicht als freigegebene AGB einsetzen. |
...
**Betriebsabgleich vom 26.09.2026:** Das Render-Dashboard zeigt den aktuellen Portalstand als `Live/Deployed`. Im Projekt existieren weiterhin nur Webdienst und PostgreSQL, kein MOS-Abgleichjob und kein Vertrags-Mailworker. Im Webdienst sind keine MOS-/Stripe-Livekonfiguration und keine Werkstatt-SMTP-Konfiguration sichtbar. Extern antworten `/healthz` mit 200 sowie `/mieten/` und `/mieten/kuendigen` mit 404. Die lokale Testabnahme ist keine Render- oder Live-Zahlungsabnahme. Die [Entscheidungsvorlage für weitere Betriebsregeln](mos-betriebsregeln-entscheidungsvorlage-2026-09-26.md) hält noch unbestätigte Rückgabe-, Tank-, Schaden-, No-show- und Kautionsfristen getrennt von bereits entschiedenen Preisen. Vor einem öffentlichen Start bleiben außer dem Versicherungsbeleg die finale Betreiber- und Rechtsfreigabe, echte Checkout-/E-Mail-Proben sowie dauerhaft eingerichteter und überwachter Webhook, Zahlungsabgleich und Vertragsversand nötig.

**Nachtrag zur Vorprüfung am 24.09.2026:** Die MOS-Seiten haben jetzt durchgehende Impressums- und Datenschutzlinks. Die vor Zahlung gezeichnete Erklärung wird als Buchungsangebot bezeichnet. Zusätzlich zu der Vertragskopie gibt es eine getrennte, neutrale Eingangsbestätigung für verifizierte bezahlte Bestellungen einschließlich Prüffällen; der Abgleich kann bezahlte Sessions ohne Webhook dafür vormerken und meldet die Webhook-Lücke weiterhin als Fehler. Die tatsächliche unverzügliche Zustellung bleibt mangels aktivem Mailworker und realem Postfachtest offen. Ein eigener Übergabenachweis sperrt die systemseitige Schlüsselübergabe, bis Vertragskopie, Kundenempfang, aktuelle Kreditkartenautorisierung, Führerschein und Zustandsprotokoll geprüft sind. Ein gesondertes öffentliches Kündigungsformular ist vorbereitet, bleibt aber bis zur Rechts- und Mailabnahme unabhängig von Neubuchungen gesperrt. Für abgebrochene Unterschriften gibt es nur einen konservativen Prüf- und Trockenlauf; eine produktive Löschung ist nicht aktiviert. [Rechtliche Vorprüfung](mos-rechtspruefung-2026-09-24.md), [Bestelleingangsbestätigung](mos-order-receipt.md), [Vertragszustellung und Übergabe](mos-contract-delivery.md), [Kündigungsweg](mos-kuendigungsweg.md), [Aufbewahrung](mos-unterschriften-aufbewahrung.md). Alle öffentlichen Live-Freigaben bleiben gesperrt.
