...
Stand 23.09.2026. **Noch kein Zahlungs-Go-live.** Ziel sind öffentliche entgeltliche Selbstfahrer-Mieten ausschließlich für **Hyundai i10 und Hyundai KONA**. C3 und Fiat sind von der Direktbuchung ausgeschlossen; Werkstatttarife bleiben manuelle Anfragen. Die Umstellung der Kaution ist im Arbeitszweig in Umsetzung und noch nicht mit echter Stripe-Testzahlung abgenommen. Die öffentliche Zahlungsroute ist weiterhin deaktiviert; keine echte Zahlung oder Kartenautorisierung wurde ausgeführt.
...
- Es gibt **keinen Mindestvorlauf**: Buchung und persönliche Abholung am selben Tag sind möglich, wenn das Fahrzeug frei ist und ein gültiger künftiger Übergabeslot angeboten wird. Verstreicht der gewählte Abholzeitpunkt während des Online-Ablaufs, wird kein Miet-Checkout mehr geöffnet; eine danach bereits eingegangene Zahlung geht zur manuellen Prüfung statt in eine automatische Buchungsbestätigung. Das Auto wird vollgetankt übergeben und vollgetankt zurückgegeben. Konkrete Übergabezeiten und maximale Mietdauer sind noch nicht vom Betreiber freigegeben. Die 1.000 € Kunden-Selbstbeteiligung beweisen keine Versicherungsdeckung.
- Der Nutzer hat **48 Stunden** und **10 % Stornogebühr** genannt; die genaue Zuordnung der Gebühr zur Frist ist noch nicht eindeutig entschieden. Der derzeitige ältere Code verwendet 24 Stunden kostenlos und danach maximal den ersten Miettag. **Diese Regel ist nicht als neue Nutzerentscheidung freigegeben und muss vor dem Livebetrieb geklärt, umgesetzt und rechtlich geprüft werden.**
...
| Betrieb / Preise / Bedingungen | i10 39 €/Tag, 500 € Kaution, 1.000 € vertragliche Selbstbeteiligung, kein Mindestvorlauf bei freiem Auto und freiem künftigen Slot sowie voll/voll sind entschieden. Konkrete Übergabeslots, maximale Mietdauer, KONA-Tarif, verbindliche Tagesberechnung, Schadenprozess und vollständiger Bedingungstext benötigen eine abschließende Betreiberfreigabe. Die 48-Stunden-/10-%-Stornoregel ist noch zu präzisieren. |
| Kaution | 500 € bei der Online-Reservierung auf Kreditkarte autorisieren, nicht einziehen. Abbruch, Storno und Rückgabe müssen die Autorisierung nach Providerabgleich freigeben. Begrenzte Autorisierungsdauer und ungeeignete lange/vorgeplante Mieten müssen in Sandbox und Betrieb berücksichtigt werden. |
| Stripe / Hosting | Stripe-Live-Konto und Render-Projekt sind im Browser erreichbar. Passender Publishable Key, nutzbarer Server-Key und signierter Webhook sind für diesen Dienst nicht eingerichtet. Die öffentliche `/mieten/`-Route antwortete zuletzt mit 404. Echte Sandbox- und Live-Abnahme fehlen; keine echte Kartenautorisierung oder Mietzahlung ausgeführt. |
...
2. Vor Freigabe den vollständigen Mietvertrag samt Storno, Schäden, voll/voll und Kautionsfreigabe rechtlich und betrieblich abnehmen. Die **48-Stunden-/10-%-Regel zuerst eindeutig entscheiden** und die alte 24-Stunden-/erster-Tag-Logik ersetzen und testen. Übergabezeiten und maximale Mietdauer passend zur realen Flotte festlegen. Ohne künftigen Slot keine gleichentägige Abholung anbieten.
...
Ebenfalls entschieden sind kein Mindestvorlauf bei freiem Fahrzeug und künftigem Übergabeslot sowie vollgetankte Übergabe und vollgetankte Rückgabe. Die Nennung von 48 Stunden und 10 % Stornogebühr ist **noch keine eindeutige Vertragsklausel**. Die technischen Änderungen für den getrennten PaymentIntent und Miet-Checkout sind im Arbeitszweig in Bearbeitung; ein echter Stripe-Test, Live-Key/Webhook und eine Betreiber-/Versicherungsfreigabe fehlen. Der Live-Schalter bleibt aus.
