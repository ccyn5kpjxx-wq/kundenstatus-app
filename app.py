...
DEFAULT_VERSICHERUNGEN = [
    {
        "name": "Aachener Münchener (Generali)",
    ...
    {
        "name": "Öffentliche Braunschweig",
        "slug": "oeffentliche-braunschweig",
    ...
    {
        "name": "Sparkassen Direkt",
        "slug": "sparkassen-direkt",
